...
<html lang="en">
    ...
    <head>
        ...
        <!--[if lt IE 9]>
  <script src="js/manage/html5shiv.min.js"></script>
  <script src="js/manage/respond.min.js"></script>
<![endif]-->
        <link href="<%=contextPath%>/css/manage/bootstrap.min.css" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/manage/common.css" />
        <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/manage/slide.css" />
        <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/manage/bootstrap.min.css" />
        <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/manage/flat-ui.min.css" />
        <link rel="stylesheet" type="text/css" href="<%=contextPath%>/css/manage/jquery.nouislider.css">
    </head>
    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                ...
                <div class="meun-item meun-item-active" href="#sour" aria-controls="sour" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_source.png">资源管理</div>
                <div class="meun-item" href="#char" aria-controls="char" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_chara_grey.png">权限管理</div>
                <div class="meun-item" href="#user" aria-controls="user" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_user_grey.png">用户管理</div>
                <div class="meun-item" href="#chan" aria-controls="chan" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_change_grey.png">修改密码</div>
                <div class="meun-title">地区管理</div>
                <div class="meun-item" href="#scho" aria-controls="scho" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_house_grey.png">地区管理</div>
                <div class="meun-item" href="#regu" aria-controls="regu" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_rule_grey.png">规则管理</div>
                <div class="meun-item" href="#stud" aria-controls="stud" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_card_grey.png">人员信息</div>
                <div class="meun-item" href="#sitt" aria-controls="sitt" role="tab" data-toggle="tab"><img src="<%=contextPath%>/images/manage/icon_char_grey.png">座位管理</div>
            </div>
            <!-- 右侧具体内容栏目 -->
            <div id="rightContent">
...
-->
<script src="<%=contextPath%>/js/manage/jquery.nouislider.js"></script>
